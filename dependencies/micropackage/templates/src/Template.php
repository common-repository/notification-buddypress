...
namespace BracketSpace\Notification\BuddyPress\Dependencies\Micropackage\Templates;

use BracketSpace\Notification\BuddyPress\Dependencies\Micropackage\Templates\Exceptions\TemplateException;
use BracketSpace\Notification\BuddyPress\Dependencies\Micropackage\Templates\Exceptions\StorageException;
...
class Template {
	 ...
	 * Filesystem instance
	 *
	 * @var BracketSpace\Notification\BuddyPress\Dependencies\Micropackage\Filesystem\Filesystem
	 */
	private $fs;
