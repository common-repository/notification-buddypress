...
class RepositoryFactory
{
    ...
    public static function manager(IOInterface $io, Config $config, ?HttpDownloader $httpDownloader = null, ?EventDispatcher $eventDispatcher = null, ?ProcessExecutor $process = null): RepositoryManager
    {
        ...
        $rm->setRepositoryClass('composer', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\ComposerRepository');
        $rm->setRepositoryClass('vcs', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('package', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\PackageRepository');
        $rm->setRepositoryClass('pear', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\PearRepository');
        $rm->setRepositoryClass('git', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('bitbucket', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('git-bitbucket', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('github', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('gitlab', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('svn', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('fossil', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('perforce', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('hg', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('artifact', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\ArtifactRepository');
        $rm->setRepositoryClass('path', 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\PathRepository');
