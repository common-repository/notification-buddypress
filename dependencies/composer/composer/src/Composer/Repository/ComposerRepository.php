...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Advisory\PartialSecurityAdvisory;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Advisory\SecurityAdvisory;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\CompleteAliasPackage;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Version\VersionParser;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Version\StabilityFilter;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Json\JsonFile;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Cache;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Plugin\PostFileDownloadEvent;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Semver\CompilingMatcher;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Plugin\PreFileDownloadEvent;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Semver\Constraint\MatchAllConstraint;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\Http\Response;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\MetadataMinifier\MetadataMinifier;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\Url;
...
class ComposerRepository extends ArrayRepository implements ConfigurableRepositoryInterface, AdvisoryProviderInterface
{
    ...
    private function asyncFetchFile(string $filename, string $cacheKey, ?string $lastModifiedTime = null): PromiseInterface
    {
        ...
        if (isset($this->packagesNotFoundCache[$filename])) {
            return \BracketSpace\Notification\BuddyPress\Dependencies\React\Promise\resolve(['packages' => []]);
        }
        ...
        if (isset($this->freshMetadataUrls[$filename]) && $lastModifiedTime) {
            ...
            $promise = \BracketSpace\Notification\BuddyPress\Dependencies\React\Promise\resolve(true);
