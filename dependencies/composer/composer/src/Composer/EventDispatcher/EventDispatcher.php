...
namespace BracketSpace\Notification\BuddyPress\Dependencies\Composer\EventDispatcher;

use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\Transaction;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Installer\InstallerEvent;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\IO\BufferIO;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\PartialComposer;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Plugin\PreCommandRunEvent;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\Platform;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\Operation\OperationInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\RepositoryInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Script;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Installer\PackageEvent;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Installer\BinaryInstaller;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\ProcessExecutor;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Script\Event as ScriptEvent;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Autoload\ClassLoader;
use BracketSpace\Notification\BuddyPress\Dependencies\Symfony\Component\Console\Application;
use BracketSpace\Notification\BuddyPress\Dependencies\Symfony\Component\Console\Command\Command;
use BracketSpace\Notification\BuddyPress\Dependencies\Symfony\Component\Console\Input\StringInput;
use BracketSpace\Notification\BuddyPress\Dependencies\Symfony\Component\Console\Output\ConsoleOutput;
use BracketSpace\Notification\BuddyPress\Dependencies\Symfony\Component\Process\PhpExecutableFinder;
use BracketSpace\Notification\BuddyPress\Dependencies\Symfony\Component\Process\ExecutableFinder;
        ...
        try {
            ...
            foreach ($listeners as $callable) {
                ...
                if (!is_string($callable)) {
                    ...
                    if (defined('BracketSpace\Notification\BuddyPress\Dependencies\Composer\Script\ScriptEvents::'.str_replace('-', '_', strtoupper($event->getName())))) {
                    ...
                    $args = implode(' ', array_map(['BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\ProcessExecutor', 'escape'], $event->getArguments()));
