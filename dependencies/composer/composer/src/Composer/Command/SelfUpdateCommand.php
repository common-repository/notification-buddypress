...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\SelfUpdate\Keys;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\SelfUpdate\Versions;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\IO\IOInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Downloader\FilesystemException;
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        class_exists('BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\Platform');
        class_exists('BracketSpace\Notification\BuddyPress\Dependencies\Composer\Downloader\FilesystemException');
