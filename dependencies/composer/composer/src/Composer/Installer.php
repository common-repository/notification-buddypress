...
namespace BracketSpace\Notification\BuddyPress\Dependencies\Composer;

use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Autoload\AutoloadGenerator;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Console\GithubActionError;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\DefaultPolicy;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\LocalRepoTransaction;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\LockTransaction;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\Operation\UpdateOperation;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\Operation\InstallOperation;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\Operation\UninstallOperation;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\PoolOptimizer;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\Pool;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\Request;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\Solver;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\SolverProblemsException;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\DependencyResolver\PolicyInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Downloader\DownloadManager;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Downloader\TransportException;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\EventDispatcher\EventDispatcher;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Filter\PlatformRequirementFilter\IgnoreListPlatformRequirementFilter;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterFactory;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Installer\InstallationManager;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Installer\InstallerEvents;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Installer\SuggestedPackagesReporter;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\IO\IOInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\AliasPackage;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\RootAliasPackage;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\BasePackage;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\CompletePackage;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\CompletePackageInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Link;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Loader\ArrayLoader;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Dumper\ArrayDumper;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Version\VersionParser;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Package;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\ArrayRepository;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\RepositorySet;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\CompositeRepository;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Semver\Constraint\Constraint;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Locker;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\RootPackageInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\InstalledArrayRepository;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\InstalledRepositoryInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\InstalledRepository;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\RootPackageRepository;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\PlatformRepository;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\RepositoryInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\RepositoryManager;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\LockArrayRepository;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Script\ScriptEvents;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Semver\Constraint\ConstraintInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Advisory\Auditor;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\Platform;
...
class Installer
{
    ...
    protected function doUpdate(InstalledRepositoryInterface $localRepo, bool $doInstall): int
    {
        ...
        } catch (\BracketSpace\Notification\BuddyPress\Dependencies\Seld\JsonLint\ParsingException $e) {
            if ($this->updateAllowList !== null || $this->updateMirrors) {
        ...
        \BracketSpace\Notification\BuddyPress\Dependencies\Composer\Semver\CompilingMatcher::clear();
