...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\EventDispatcher\EventSubscriberInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Installer\InstallerInterface;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Plugin\Capability\Capability;
...
class PluginManager
{
    ...
    public function registerPackage(PackageInterface $package, bool $failOnMissingClasses = false, bool $isGlobalPlugin = false): void
    {
        ...
        foreach ($map['files'] as $fileIdentifier => $file) {
            ...
            \BracketSpace\Notification\BuddyPress\Dependencies\Composer\Autoload\composerRequire($fileIdentifier, $file);
        }
        ...
        foreach ($classes as $class) {
            ...
            if ($oldInstallerPlugin) {
                if (!is_a($class, 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Installer\InstallerInterface', true)) {
                ...
                if (!is_a($class, 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Plugin\PluginInterface', true)) {
