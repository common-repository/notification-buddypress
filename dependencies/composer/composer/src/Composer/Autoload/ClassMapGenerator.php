...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\ClassMapGenerator\FileList;
...
class ClassMapGenerator
{
    ...
    {
        $generator = new \BracketSpace\Notification\BuddyPress\Dependencies\Composer\ClassMapGenerator\ClassMapGenerator(['php', 'inc', 'hh']);
