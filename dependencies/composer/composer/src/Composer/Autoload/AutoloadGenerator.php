...
namespace BracketSpace\Notification\BuddyPress\Dependencies\Composer\Autoload;

use BracketSpace\Notification\BuddyPress\Dependencies\Composer\ClassMapGenerator\ClassMap;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\ClassMapGenerator\ClassMapGenerator;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Semver\Constraint\Bound;
...
EOF;
        ...
        $classMap->addClass('BracketSpace\Notification\BuddyPress\Dependencies\Composer\InstalledVersions', $vendorPath . '/composer/InstalledVersions.php');
        $classMap->sort();
...
class ComposerAutoloaderInit$suffix
{
    ...
    {
        if ('BracketSpace\\Notification\\BuddyPress\\Dependencies\\Composer\\Autoload\\ClassLoader' === \$class) {
            require __DIR__ . '/ClassLoader.php';
        }
    }

    /**
     * @return \BracketSpace\Notification\BuddyPress\Dependencies\Composer\Autoload\ClassLoader
     */
...
PLATFORM_CHECK;
        ...
        self::\$loader = \$loader = new \\BracketSpace\\Notification\\BuddyPress\\Dependencies\\Composer\\Autoload\\ClassLoader(\\dirname(__DIR__));
...
INCLUDE_PATH;
        ...
        call_user_func(\BracketSpace\Notification\BuddyPress\Dependencies\Composer\Autoload\ComposerStaticInit$suffix::getInitializer(\$loader));
...
REGISTER_LOADER;
        ...
        if ($useIncludeFiles) {
            $file .= <<<INCLUDE_FILES
        \$filesToLoad = \BracketSpace\Notification\BuddyPress\Dependencies\Composer\Autoload\ComposerStaticInit$suffix::\$files;
