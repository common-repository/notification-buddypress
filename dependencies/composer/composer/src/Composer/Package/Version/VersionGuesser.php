...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\Vcs\HgDriver;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\IO\NullIO;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Semver\VersionParser as SemverVersionParser;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\Svn as SvnUtil;
use BracketSpace\Notification\BuddyPress\Dependencies\React\Promise\CancellablePromiseInterface;
                        ...
                        if (strlen($output) < $length) {
                            ...
                            if ($length === 0) {
                                foreach ($promises as $promise) {
                                    ...
                                    \BracketSpace\Notification\BuddyPress\Dependencies\React\Promise\resolve($promise)->cancel();
                                }
                            }
                        }
                    });
