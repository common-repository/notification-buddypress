...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Config\ConfigSourceInterface;
...
class Config
{
     ...
     * "scripts": {
     *   "watch": [
     *     "BracketSpace\\Notification\\BuddyPress\\Dependencies\\Composer\\Config::disableProcessTimeout",
