...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Archiver;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\Version\VersionGuesser;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\RootPackageInterface;
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Repository\FilesystemRepository;
...
use BracketSpace\Notification\BuddyPress\Dependencies\Composer\Util\Loop;
...
class Factory
{
    ...
    public function createComposer(IOInterface $io, $localConfig = null, $disablePlugins = false, ?string $cwd = null, bool $fullLoad = true, bool $disableScripts = false)
    {
        ...
        if ($fullLoad) {
            ...
            if (false === $disablePlugins && false === $disableScripts && !class_exists('BracketSpace\Notification\BuddyPress\Dependencies\Composer\InstalledVersions', false) && file_exists($installedVersionsPath = $config->get('vendor-dir').'/composer/installed.php')) {
                ...
                if (class_exists('BracketSpace\Notification\BuddyPress\Dependencies\Composer\InstalledVersions')) {
        ...
        $package = $loader->load($localConfig, 'BracketSpace\Notification\BuddyPress\Dependencies\Composer\Package\RootPackage', $cwd);
