...
namespace BracketSpace\Notification\BuddyPress\Dependencies\BrianHenryIE\Strauss;
...
use BracketSpace\Notification\BuddyPress\Dependencies\BrianHenryIE\Strauss\Helpers\Path;
use BracketSpace\Notification\BuddyPress\Dependencies\League\Flysystem\Filesystem;
use BracketSpace\Notification\BuddyPress\Dependencies\League\Flysystem\Local\LocalFilesystemAdapter;
...
class FileEnumerator
{
    ...
    public function compileFileList(): DiscoveredFiles
    {
        foreach ($this->dependencies as $dependency) {
             ...
             *
             * [ "psr-4" => [ "BracketSpace\Notification\BuddyPress\Dependencies\BrianHenryIE\Strauss" => "src" ] ]
...
//                          $this->findFilesInDirectory()
    ...
    /**
     * @uses \BracketSpace\Notification\BuddyPress\Dependencies\BrianHenryIE\Strauss\DiscoveredFiles::add()
     *
     * @param ComposerPackage $dependency
     * @param string $packageRelativePath
     * @param string $autoloaderType
     * @throws \BracketSpace\Notification\BuddyPress\Dependencies\League\Flysystem\FilesystemException
     */
